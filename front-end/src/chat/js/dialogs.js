...
function getDialogIcon (dialogType) {
  var groupPhoto = '<img src="src/chat/images/ava-group.svg" width="30" height="30" class="round">';
  var privatPhoto  = '<img src="src/chat/images/ava-single.svg" width="30" height="30" class="round">';
